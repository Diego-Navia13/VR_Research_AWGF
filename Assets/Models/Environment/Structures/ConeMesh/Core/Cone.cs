...
namespace KevinCastejon.ConeMesh
{
    ...
    public class Cone : MonoBehaviour
    {
        ...
        [SerializeField]
        private Material outsideConeMaterial; // Reference to the Outside Cone material
        [Min(3)]
        [SerializeField]
        ...
        public Material Material { get => _material; set { _material = value; _meshRenderer = _meshRenderer ? _meshRenderer : gameObject.GetComponent<MeshRenderer>(); _meshRenderer.sharedMaterial = _material; } }
        ...
        void Start()
        {
            // Ensure the material is set to Outside Cone
           // if (outsideConeMaterial == null)
            //{
              //  Debug.LogError("Outside Cone Material is not assigned.");
                //return;
            //}
            //_material = outsideConeMaterial;
            //GenerateCone();
        }
        ...
        internal void GenerateCone()
        {
            ...
            _meshRenderer.sharedMaterial = _material; // Use sharedMaterial to persist across scenes
